...
![](images/yr9_spring_r4_(2026)_1.png)

- Gradient of line passing through the points  and is 4. Find the value of .
- Find the gradient and intercept of the line . 
- Find equation of line parallel to line  and passing through point .
-  a.  Find the  and intercepts of line . 

 b.  Hence sketch the line.  

- a.   Draw lines  and  on the same set of axes:         ![](images/yr9_spring_r4_(2026)_2.png)

- Hence solve simultaneous equations graphically, using your graph.
- M is the midpoint of AB and Triangle BCX is isosceles. Find perimeter of triangle ABC.

  ![](images/yr9_spring_r4_(2026)_3.png)

- Find the angle , clearly state the reasoning.

	![](images/yr9_spring_r4_(2026)_4.png)
